      ...
      <div className="container">
        <div className="form-menu">
          ...
          <div className="d-flex flex-column mb-3 mt-5 text-center">
            <Link to={"/staff/list"}>
              <button type="button" className="btn btn-primary button mt-3" onClick={() => moveToStaffList()}>
                スタッフ管理
              </button>
            </Link>
            <Link to={"/order"}>
              <button type="button" className="btn btn-primary button mt-3" onClick={() => moveToOrderList()}>
                オーダー管理
              </button>
            </Link>
          </div>
